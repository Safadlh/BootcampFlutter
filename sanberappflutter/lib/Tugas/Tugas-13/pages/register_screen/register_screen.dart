...
import 'package:sanberappflutter/Tugas/Tugas-13/pages/login_screen/login_screen.dart';
                ...
                child: ListView(
                  children: [
                    Container(
                      ...
                      child: Image.asset("assets/img/logo-JF.png")),
                    Text("JobFinder",
                        style: TextStyle(
                          fontSize: 18,
                    ...
                    Text("Exploring Your Dream Jobs",
                        style: TextStyle(
                          fontSize: 18,
